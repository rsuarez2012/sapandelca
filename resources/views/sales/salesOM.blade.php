            ...
            <section class="content invoice">
              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                  <p class="lead">Metodo de Pago:</p>
                      <select class="form-control" id="format_buy" name="format_buy">
                            ...
                            <option value="8">CREDITO</option>
                            <option value="9">OTROS TIPOS DE PAGO</option>
                            
                    </select>
                    <div class="clearfix"></div>
                    <div class="observation" id="observation" style="display: none;">
                        <p class="lead">Motivo de la Donacion</p>
                        <textarea name="observation" id="observation" class="form-control"></textarea>
                    </div>
                    <div class="observation" id="type_fo" style="display: none;">
                        <p class="lead">Tipos de pago</p>
                        <textarea name="observation" id="observation" class="form-control"></textarea>
                    </div>
                    <div class="observation">
                        <p class="lead">Observaciòn de la ventas</p>
                        <textarea name="observation" id="observation" class="form-control"></textarea>
                    </div>
                    
                    <div class="clearfix"></div>

                    <div class="despachador">
                        <p class="lead">Despacha</p>
                        <select class="form-control" id="format_buy" name="employe_id">
                            <option value="" selected disabled>Empleado</option>
                            @foreach($employes as $employe)
                                <option value="{{$employe->id}}">{{$employe->name.' '.$employe->last_name}}</option>
                            @endforeach
                    </select>
                    </div>
                </div>
                ...
                <div class="col-xs-3">
                    <div>
                        ...
                        <label><input type="radio" name="point" value="1">BOD</label>
                        <label><input type="radio" name="point" value="2">BANCARIBE</label>
                    </div>
                    <br>
                    <div class="reference">
                        <p class="lead">Numero de referencia</p>
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <input type="hidden" name="total_credito" id="total_credito" value="">
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <div class="row no-print">
                <div class="col-xs-12" id="guardar">
                  ...
                  <button type="submit" class="btn btn-success pull-right" ><i class="fa fa-credit-card"></i> Registrar Venta</button>

...
<body>
    ...
    @if($sales->count() > '0')
            ...
            <span class="col-md-3 pull-right">                
                ...
                <h4>FECHA: {{ Carbon\Carbon::parse($sell_today)->format('d/m/Y') }}</h4>
                <h4>HORA: {{ Carbon\Carbon::parse($sell_today)->format('H:i') }}</h4>
            </span>
        ...
        <table>
                    <thead>
                        <tr>
                            <th colspan="4">
                                <h3 align="center">VENTAS DEL DIA </h3>
                            </th>
                        </tr>
                        <tr>
    ...
    <div class="row" align="center">
    	<span class="badge bg-red">
			...
			<h2>No hay ventas registradas para el dia ({{Carbon\Carbon::parse($sell_today)->format('d-m-Y')}}).! </h2>
